                ...
                <tr key={cat.id}>
                  ...
                  <td className="text-center py-3">
                    <Badge 
                      ...
                      className={`px-3 py-2 text-uppercase rounded-pill ${
                        isActive ? 'bg-success-subtle text-success border border-success-subtle' : 'bg-secondary-subtle text-secondary border border-secondary-subtle'
                      }`}
