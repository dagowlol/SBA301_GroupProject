...
public class AuctionSessionController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get auction session detail",
               description = "Returns auction session details including item info, current price, winner, and latest 10 bid logs.")
